                ...
                <div className="site-footer px-6 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-300 py-4 ltr:ml-[248px] rtl:mr-[248px]">
                    <div className="grid md:grid-cols-2 grid-cols-1 md:gap-5">
                        <div className="text-center ltr:md:text-start rtl:md:text-right text-sm">
                            ...
                            برای دش کد محفوظ است.
                        </div>
                        <div className="ltr:md:text-right rtl:md:text-end text-center text-sm">
                            فروش فقط در
                            <a href="#" target="_blank" className="text-primary-500 font-semibold">
                                دیتی شاپ
                            </a>
                        </div>
                    </div>
    ...
    backdrop-filter backdrop-blur-[40px] fixed left-0 bottom-0 w-full z-[9999] bothrefm-0 py-[12px] px-4 md:hidden">
          ...
          text-slate-900 ">
            ...
            justify-center rounded-full text-white z-[99]">
                        ...
                        <span className="block text-[11px] text-slate-600 dark:text-slate-300">پیام ها</span>
                    </div>
                </a>
      ...
      h-[65px] w-[65px] z-[-1] -mt-[40px] flex justify-center items-center">
                    <div className="h-[50px] w-[50px] rounded-full relative left-[0px] hrefp-[0px] custom-dropshadow">
                        <img src="/src/AdminPanel/assets/images/users/user-1.jpg" alt="" className="w-full h-full rounded-full border-2 border-slate-100" />
                    </div>
                </a>
                <a href="index.html#">
                    <div>
          ...
          text-slate-900">
            ...
            justify-center rounded-full text-white z-[99]">
                        ...
                        <span className=" block text-[11px] text-slate-600 dark:text-slate-300">نوتیفیکیشن ها</span>
                    </div>
                </a>
            </div>
        </>
