  ...
  return (
    <div class="iq-sidebar  sidebar-default ">
        <div class="iq-sidebar-logo d-flex align-items-center">
            <a href="https://templates.iqonic.design/glare/laravel/public/dashboard" class="header-logo">
        ...
        <div class="data-scrollbar" data-scroll="1">
            <nav class="iq-sidebar-menu">
                ...
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    <li class="active">
                        <a href="https://templates.iqonic.design/glare/laravel/public/dashboard" class="svg-icon">
                    ...
                    <li class="">
                        <a href="https://templates.iqonic.design/glare/laravel/public/analytics" class="svg-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"
                                width="20" height="20">
                    ...
                    <li class="">
                        ...
                        <ul id="form" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li class="">
                                <a href="https://templates.iqonic.design/glare/laravel/public/forms/inputgroup" class="svg-icon">
                                    <i class="las la-minus"></i><span class="">Form Input</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="https://templates.iqonic.design/glare/laravel/public/forms/validation" class="svg-icon">
                                    <i class="las la-minus"></i><span class="">Form Validation</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="https://templates.iqonic.design/glare/laravel/public/forms/switch" class="svg-icon">
                                    <i class="las la-minus"></i><span class="">Form Switch</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="https://templates.iqonic.design/glare/laravel/public/forms/checkbox" class="svg-icon">
                                    <i class="las la-minus"></i><span class="">Form Checkbox</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="https://templates.iqonic.design/glare/laravel/public/forms/radio" class="svg-icon">
                                    <i class="las la-minus"></i><span class="">Form Radio</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="https://templates.iqonic.design/glare/laravel/public/forms/textarea" class="svg-icon">
                ...
                <div class="card border-none  shadow-none">
                    <div class="card-body rounded-pill bg-secondary">
                        <div class="sidebarbottom-content">
                            <div class="image"><img src="https://templates.iqonic.design/glare/laravel/public/images/sidebar.png" class="img-fluid" alt="sidebar"/>
                            </div>
