                                ...
                                <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                    ...
                                    <li class="nav-item nav-icon dropdown caption-content">
                                        <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center"
                                            ...
                                            aria-expanded="false">
                                            <img src="https://templates.iqonic.design/glare/laravel/public/images/user/1.jpg" class="img-fluid rounded" alt="user" />
                                                    ...
                                                    <div class="profile-header">
                                                        <div class="cover-container text-center">
                                                            ...
                                                            <form method="POST" action="https://templates.iqonic.design/glare/laravel/public/logout">
                                                                <input type="hidden" name="_token" value="kS7jAiFNbvzLkTvD8iB5RYf2ZNjUZJiOkIhCQdjk" />                                                    <a href="javascript:void(0)" class="btn btn-primary"
