        ...
        <div className="min-lg:h-[80%] min-md:w-[80%] min-lg:mr-30 flex items-center justify-center min-sm:p-4">
          ...
          >
            ...
            <motion.div
              ...
              className="bg-white/40 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8"
            >
              <form onSubmit={handleSubmit} className="space-y-8">
                {/* اطلاعات پایه */}
                <div className="space-y-6">
                  <h2 className="text-xl font-semibold text-gray-800 flex items-center justify-between gap-2">
