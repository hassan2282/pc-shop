    ...
    <motion.div
     ...
     border-white/20 min-md:mr-10 mt-4 min-h-96 max-md:w-full min-md:w-[92%] min-w-[50rem]'>
      ...
      backdrop-blur-md h-24 rounded-t-2xl border-b border-white/20'>
        ...
        <h3 className='min-md:text-2xl text-lg font-bold text-gray-800'>مدیریت کد دسترسی</h3>
        ...
        <table className='w-full min-w-[50rem] '>
          <thead>
           ...
           h-16 text-md justify-center text-center border border-gray-200 shadow-sm'>
              ...
              <th className='font-semibold col-span-1'>کد دسترسی</th>
          ...
          <tbody className=''>
            {
              ...
              <tr className='w-full grid grid-cols-4 items-center text-gray-600/90
                            p-4 text-md justify-center text-center bg-white/60 hover:bg-blue-50/50 rounded-xl 
                            cursor-pointer transition-all duration-200 border border-gray-100/50'>
                <td className=''>{1}</td>
                <td className=''>#{gate.id}</td>
                <td className=''>{gate.gkey.slice(0,20) + '...'}</td>
                <td className='flex flex-row space-x-3 *:hover:scale-110 justify-center items-center'>
                  <button onClick={() => deleteHandler(gate.id)} className='text-red-600 cursor-pointer hover:text-red-700 transition-colors duration-200' title='حذف'>
