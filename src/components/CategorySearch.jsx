                                                ...
                                                <div className="product-box">
                                                    ...
                                                    <a className="product-box-img" href="single-product.html">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li className="color_pro bg-[#4e1dac] top-[20px]" ></li>
                                                            <li className="color_pro bg-[#ff0075] top-[33px]" ></li>
                                                        </ul>
                                                    </a>
                                                ...
                                                <div className="product-box">
                                                    ...
                                                    <a className="product-box-img" href="single-product.html">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li className="color_pro bg-[#f00] top-[20px]" ></li>
                                                            <li className="color_pro bg-[#0f0] top-[33px]" ></li>
                                                        </ul>
                                                    </a>
                                                    <div className="product-box-content">
                                                        <div className="product-box-content-row">
                                                ...
                                                <div className="product-box">
                                                    ...
                                                    <a className="product-box-img" href="single-product.html">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li className="color_pro bg-[#18bd71] top-[20px]"></li>
                                                            <li className="color_pro bg-[#d500ff] top-[33px]"></li>
                                                        </ul>
                                                    </a>
                                                    <div className="product-box-content">
                                                        <div className="product-box-content-row">
                                                ...
                                                <div className="product-box">
                                                    ...
                                                    <a className="product-box-img" href="single-product.html">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li className="color_pro bg-[#000] top-[20px]" ></li>
                                                            <li className="color_pro bg-[#93d337] top-[33px]" ></li>
                                                        </ul>
                                                    </a>
                                                    <div className="product-box-content">
                                                        <div className="product-box-content-row">
                                                ...
                                                <div className="product-box">
                                                    ...
                                                    <a className="product-box-img" href="single-product.html">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li className="color_pro bg-[#278e3c] top-[20px]"></li>
                                                            <li className="color_pro bg-[#d500ff] top-[33px]"></li>
                                                        </ul>
                                                    </a>
                                                    <div className="product-box-content">
                                                ...
                                                <div className="product-box">
                                                    ...
                                                    <a className="product-box-img" href="single-product.html">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li className="color_pro bg-[#1aea44] top-[20px]"></li>
                                                            <li className="color_pro bg-[#70367c] top-[33px]"></li>
                                                        </ul>
                                                    </a>
                                                    <div className="product-box-content">
                                                        <div className="product-box-content-row">
                                                ...
                                                <div className="product-box">
                                                    ...
                                                    <a className="product-box-img" href="single-product.html">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li className="color_pro bg-[#8e278c] top-[20px]"></li>
                                                            <li className="color_pro bg-[#ff004e] top-[33px]"></li>
                                                        </ul>
                                                    </a>
                                                    <div className="product-box-content">
                                                        <div className="product-box-content-row">
