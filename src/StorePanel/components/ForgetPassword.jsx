  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.status >= 200 && res.status < 300) {
        ...
        navigate('/store/email-confirm', { replace: true });
                  ...
                  <motion.div
                    ...
                    <div className="w-full">
                      <input
                        ...
                        required
                        className="w-full p-3 rounded-full shadow-xs shadow-black/20 hover:shadow-lg
                         bg-white/50 focus:outline-none focus:ring-2 focus:ring-[#009EA4]"
                        type="email"
