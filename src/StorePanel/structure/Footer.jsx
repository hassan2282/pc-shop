                        ...
                        <div className="col-12 col-md-6 col-lg-3">
                            <div className="widget-menu widget card">
                                ...
                                <p className="about_footer">
                                    لورم ایپسوم، شباهت زیادی به متن (به‌معنای واقعی) دارد. اگر طراح چند متن و کلمه‌ی دیگر را به‌حای لورم ایپسوم چندین بار برای جانمایی آزمایشی کپی کند، شاید توزیع حروف به‌صورت مناسب انجام نشود. با استفاده از لورم ایپسوم
                                </p>
                            </div>
                        </div>
                        <div className="col-12 col-md-6 col-lg-3">
